...
* [Staging workspace registered model](https://adb-2394900699530152.12.azuredatabricks.net#mlflow/models/staging-mlops-demo-model)
* [Prod workspace registered model](https://adb-6422991651043538.18.azuredatabricks.net#mlflow/models/prod-mlops-demo-model)
